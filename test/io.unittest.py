...
# Last Change: Fri Jan 18, 2019 at 07:24 AM -0500
...
from pyUTM.io import PcadNetsReader
...
class PcadNetsReaderTester(unittest.TestCase):
    def test_net_node_gen(self):
        self.assertEqual(PcadNetsReader.net_node_gen(None, None),
                         NetNode(None, None, None, None))
        self.assertEqual(PcadNetsReader.net_node_gen(('JD1', '1'), None),
                         NetNode('JD1', '1', None, None))
        self.assertEqual(PcadNetsReader.net_node_gen(None, ('JP1', '1')),
                         NetNode(None, None, 'JP1', '1'))
        self.assertEqual(PcadNetsReader.net_node_gen(('JD1', '2'), ('JP1', '1')),
                         NetNode('JD1', '2', 'JP1', '1'))

    def test_find_node_match_regex(self):
        self.assertEqual(
            PcadNetsReader.find_node_match_regex(
    ...
    def test_parse_netlist_dict_dcb_pt(self):
        reader = PcadNetsReader('/dev/null')
        self.assertEqual(
